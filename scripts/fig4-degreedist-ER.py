...
ax.hist(d2, weights=w2, bins=36, color='#648fff', alpha=0.5, density=True, label='Simulation')
...
ax.text(-0.14, 0.85, "a", fontsize=20, ha='center', va='center', transform=ax.transAxes, color='black', fontweight='bold', fontname='DejaVu Sans')
