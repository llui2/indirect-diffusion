...
def f(x, d, N):
    return (lambda2_ER(N, p_total(d,x,N), 1) - lambda2_RR(N, x, 1)) / N
...
t_theory = [(N - lambda2_RR(N, x, 1)) / N for x in p_theory]
...
ax.text(-0.14, 0.85, "b", fontsize=22, ha='center', va='center', transform=ax.transAxes, color='black', fontweight='bold', fontname='DejaVu Sans')
